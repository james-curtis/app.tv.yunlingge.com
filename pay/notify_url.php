...
if($verify_result) {//验证成功
  ...
  $sendUrl = 'http://yshy.mingdi.xyz/login/login/pay.html';
	...
	if($u_id){
		//file_put_contents('../public/64.txt',$out_trade_no,FILE_APPEND);
		$Url="http://yshy.mingdi.xyz/index/pay/pay_daili.html?u_id={$u_id}&outtrade={$out_trade_no}";
		$content = juhecurl($Url,$smsConf);
		file_put_contents('../public/3.txt','我成功了'.$content,FILE_APPEND);
		return 'success';
	}
