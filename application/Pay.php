...
//decode by 官方QQ:927857669 客服VX：12345
		...
		if ($_var_0) {
			...
			if ($_var_1) {
				if ($_var_1['power'] == 0 || $_var_1['power'] == 1) {
					...
					return json(['code' => 200, 'pay_url' => "http://yshy.mingdi.xyz/pay/index.php?name=代理&fee={$_var_2}&u_id={$_var_0}"]);
				}
			} else {
